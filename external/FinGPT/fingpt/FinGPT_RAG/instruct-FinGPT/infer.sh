...
# /xfs/home/your-user/chatds/llama/llama2-7b-hf
# deepspeed --num_gpus 8 ./inference/batchbot.py --path facebook/opt-1.3b --max_new_tokens 16 --debug
# deepspeed --num_gpus 8 ./inference/batchbot.py --path /xfs/home/your-user/chatds/llama/llama2-7b-hf --max_new_tokens 16 --debug true
# deepspeed --num_gpus 8 ./inference/batchbot.py --path checkpoints/actor-models/sent-llama-7b --max_new_tokens 16 --debug true

python ./inference/batchbot_torch.py --path /xfs/home/your-user/chatds/llama/llama2-7b-hf --max_new_tokens 16 --debug
