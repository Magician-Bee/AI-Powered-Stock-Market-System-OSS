...
class OnlineSimulationExample:
    def __init__(
        ...
        task_url="mongodb://192.0.2.1:27017/",  # not necessary when using TrainerR or DelayTrainerR
        ...
        Args:
            ...
            task_url (str, optional): your MongoDB url. Defaults to "mongodb://192.0.2.1:27017/".
