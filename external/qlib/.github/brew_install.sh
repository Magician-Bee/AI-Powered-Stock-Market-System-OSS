...
# On Linux, it installs to /home/your-user/.linuxbrew if you have sudo access
...
if [[ -z "${HOMEBREW_ON_LINUX-}" ]]; then
  ...
  HOMEBREW_PREFIX_DEFAULT="/home/your-user/.linuxbrew"
...
if [[ -z "${HOMEBREW_ON_LINUX-}" ]]; then
 have_sudo_access
  ...
  if [[ -n "${CI-}" ]] || [[ -w "$HOMEBREW_PREFIX_DEFAULT" ]] || [[ -w "/home/your-user" ]] || [[ -w "/home" ]]; then
