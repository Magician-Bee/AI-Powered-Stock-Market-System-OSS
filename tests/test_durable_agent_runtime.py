...
def test_natural_root_correction_replaces_the_active_run(tmp_path):
    ...
    async def scenario():
        ...
        assert corrected["steering"]["intent"] == "hard_steer"
        ...
        assert runtime.get_run(replacement_id)["objective"] == "改為比較台積電與台新新光金的風險差異。"
