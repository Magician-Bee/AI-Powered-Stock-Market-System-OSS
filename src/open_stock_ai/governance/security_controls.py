...
SECURITY_CONTROLS: tuple[SecurityControl, ...] = (
    ...
    SecurityControl(
        ...
        ("src/open_stock_ai/integration_audit.py", "src/stock_ai/agent_run_store.py", "tests/test_security_controls.py"),
        ("immutable_off_host_security_audit_sink_and_order_reconstruction_receipt_are_not_yet_configured",),
    ),
    SecurityControl(
        "SEC-010",
        "Threat model",
