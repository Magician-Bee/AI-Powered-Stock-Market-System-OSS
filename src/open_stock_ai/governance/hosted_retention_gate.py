...
REQUIRED_CRITICAL_SCHEMAS = (
    ...
    "open_stock_ai.paper_borrow_fee_batch.v1",
    "open_stock_ai.paper_settlement_batch.v1",
    "open_stock_ai.settlement_pnl_feed.v1",
    "stock_ai.broker_reconciliation_execution.v1",
    "stock_ai.account_reconciliation_receipt.v1",
    "stock_ai.account_reconciliation_execution.v1",
    "stock_ai.security_trading_audit_event.v1",
)
