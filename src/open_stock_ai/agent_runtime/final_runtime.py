...
from .interaction import DurableInteractionStore, SteeringIntent, SteeringRouter
...
class FinalAgentRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        self.interaction_store = DurableInteractionStore(self.path, self.checkpoints)
    ...
    def create_interaction(
        ...
        *,
        ...
        return self.interaction_store.create(
            session_id=session_id,
            run_id=run_id,
            branch_id=branch_id,
    ...
    def interactions(
        ...
        *,
        ...
        return self.interaction_store.list_for_session(
            session_id,
            open_only=open_only,
        )
    ...
    def cancel_interactions_for_run(self, run_id: str, *, reason: str) -> int:
        ...
        return self.interaction_store.cancel_for_run(run_id, reason=reason)
    ...
    def record_user_proposal(
        ...
        *,
        ...
        return self.interaction_store.record_proposal(
            session_id=session_id,
            message_id=message_id,
            branch_id=branch_id,
    ...
    def update_user_proposal_evaluation(
        ...
        *,
        ...
        return self.interaction_store.update_proposal_evaluation(
