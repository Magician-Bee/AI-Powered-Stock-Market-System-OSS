...
# Bounded official-data research may fan out across multiple source requests.
# This remains a cancellable Host task, with the same per-source admission.
READ_ONLY_RESEARCH_PROFILE = WorkerProfile("read_only_research", "supervised_read_only_research_task", 120, 600)
...
def profile_for(worker_type: str) -> WorkerProfile:
    ...
    return {
        READ_ONLY_RESEARCH_PROFILE.worker_type: READ_ONLY_RESEARCH_PROFILE,
