...
class MarketDataPlatform:
    ...
    def sync_security_master_payloads(
        ...
        *,
        ...
        snapshot_hash = content_hash(payloads)
        ...
        normalized = consolidate_security_snapshots(
            snapshots,
            acquired_at=acquired,
            existing_inventory=self.warehouse.identity_inventory(),
        )
            ...
            items.append(
                {
                    ...
                    "symbol": row.get("display_symbol") or metadata.get("display_symbol"),
